    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ...
                ->booleanNode('addMethodsInInterfaces')->defaultFalse()->info('Whether to add methods in interfaces')->end()
                ->booleanNode('addUselessPhpDoc')->defaultFalse()->info('Generate phpDoc blocks even when they\'re obvious')->end()
                ->scalarNode('translationMethod')->defaultFalse()->info('Method for handling property translations')->end()
                ...
                ->arrayNode('types')
                    ...
                    ->prototype('array')
                        ->children()
                            ...
                            ->booleanNode('enum')->defaultFalse()->info('Is this class an enum?')->end()
                            ->arrayNode('namespaces')
                                ->addDefaultsIfNotSet()
                            ...
                            ->arrayNode('constants')
                                ->info('Any constants to add to the result class')
                                ->useAttributeAsKey('name')
                                ->prototype('scalar')->end()
                            ->end()
                            ->arrayNode('interfaces')
                                ->info('Any interfaces to add to the resulting class')
                                ->useAttributeAsKey('name')
                                ->prototype('scalar')->end()
                            ->end()
                            ->arrayNode('traits')
                                ->info('Any traites to add to the resulting class')
                                ->useAttributeAsKey('name')
                                ->prototype('scalar')->end()
                            ->end()
